package com.orangehrm.PO.pages.Admin.AdminTopNavMenu;
...
public class AdminTopNavMenu extends TestBase {
    ...
    /**
     * Clicks on the "Job" navigation button on the top navbar.
     */
    ...
    /**
     * Navigates to the Job Titles page by clicking on the "Job" navigation button and then clicking on the "Job Titles" link.
     */
