...
public class TestBase {
    ...
    /**
     * This method is used to set up the test environment by loading the required
     * configuration files and setting up the WebDriver instance.
     * 
    ...
    /**
     * Logs a pass message in the extent report. If the takeScreenshot parameter
     * is true, a screenshot is taken and attached to the report.
     * 
    ...
    /**
     * Logs a fail message in the extent report. If the takeScreenshot parameter
     * is true, a screenshot is taken and attached to the report. This method
     * will also mark the test as failed.
     * 
     * @param message The message to be logged
     * @param takeScreenshot Whether to take a screenshot
     */
    ...
    public void logInfo(String message, boolean b) {
    ...
    public boolean waitForElementToBeClickable(WebElement element, int timeoutInSeconds, String passMessage,
            String failMessage, boolean throwException) {
    ...
    public void waitForAlertToBePresent(int timeOut, String message) {
        ...
        try {
            ...
            logInfo("No alert present within the specified timeout.", false);
        }
    }
    ...
    public void selectOptionFromDropdown(WebElement element, String option, String message, int timeOut) {
        ...
        try {
            ...
            WebElement optionToBeSelected = Hooks.driver
                    .findElement(By.xpath("//div[@role='listbox']/div/span[text()='" + option + "']"));
    ...
    public void selectOptionFromDropdown(String option, String message) {
        try {
            WebElement optionToBeSelected = Hooks.driver
                    .findElement(By.xpath("//div[@role='listbox']/div/span[contains(text(),'" + option + "')]"));
            clickElement(optionToBeSelected, message, true, 20);
            logInfo(message, true);
        } catch (NoSuchElementException e) {
            Assert.fail("Error: Option not found in the dropdown.");
