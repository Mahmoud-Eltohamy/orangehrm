...
import com.orangehrm.PO.pages.Admin.AdminTopNavMenu.AdminTopNavMenu;
import com.orangehrm.PO.pages.Admin.Job.JobTitle.JobTitlePage;
import com.orangehrm.PO.pages.PIM.EmployeeList.EmployeeInformation.EmployeeInformationPage;
import com.orangehrm.PO.pages.PIM.EmployeeList.Job.JobPage;
import com.orangehrm.PO.pages.PIM.EmployeeList.PersonalDetails.PersonalDetails;
...
public class JobTitleFeature {
    ...
    public void validate_Required_Error_Message_Is_Present() {
        JobTitlePage jobTitlePage = new JobTitlePage(Hooks.driver);
        jobTitlePage.validate_Required_Error_Message_Is_Present();
    }
